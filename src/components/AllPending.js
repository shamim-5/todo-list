...
const AllPending = ({ handleUpdateButton, handleDelete, handleCompletedRadio }) => {
  const [todo] = useToDo();

  return (
    <div>
      <h2 className="md:text-start text-center uppercase text-4xl font-semibold text-[#38BDF8] pt-2">Pending todo's</h2>
